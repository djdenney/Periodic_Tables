...
module.exports = {
    ...
    update: [hasData, hasReservationId, asyncErrorBoundary(reservationExists), asyncErrorBoundary(hasSufficientCapacity), tableIsOccupied, asyncErrorBoundary(update)],
    list: [asyncErrorBoundary(list)],
    remove: [asyncErrorBoundary(tableIdExists), tableIsNotOccupied, asyncErrorBoundary(remove)]
} 